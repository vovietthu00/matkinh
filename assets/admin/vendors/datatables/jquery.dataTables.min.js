...
fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Đầu",sLast:"Cuối",sNext:"Sau",sPrevious:"Trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Hiển thị _START_ đến _END_ trong tổng _TOTAL_ mục",sInfoEmpty:"Hiển thị 0 đến 0",sInfoFiltered:"(lọc từ _MAX_ mục)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Đang tải...",sProcessing:"Đang xử lý...",sSearch:"Tìm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả phù hợp"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(l.defaults);l.defaults.column={aDataSort:null,
